...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["rmappo", "mappo", "happo", "hatrpo", "rode", "roma", "mat", "mat_dec"])
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='towerDefense', help="specify the name of environment")
    ...
    parser.add_argument("--n_roles", type=int, default=3,
                        help="Number of roles for RODE algorithm")
