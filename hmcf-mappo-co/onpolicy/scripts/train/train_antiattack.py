...
def make_train_env(all_args):
    ...
    # if all_args.env_name == "antiAttack":
...
def parse_args(parser):
    ...
    parser.add_argument("--train_episodes", type=int, default=int(3000), help=" Maximum number of training episodes")
...
def main():
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.anti_attack_runner import ANTIATTACKRunner as Runner
    else:
        # print('runner wrong in train_antiattack.py line 264.')
        from onpolicy.runner.shared.anti_attack_runner import ANTIATTACKRunner as Runner
