...
def get_config():
    ...
    parser.add_argument("--seed", type=int, default=2024, help="Random seed for numpy/torch")
    parser.add_argument("--cuda", action='store_false', default=True, help="by default True, will use GPU to train; or else will use CPU;")
    parser.add_argument("--cuda_deterministic",
                        action='store_false', default=True, help="by default, make sure random seed effective. if set, bypass such function.")
    parser.add_argument("--n_training_threads", type=int,
                        default=1, help="Number of torch threads for training")
    parser.add_argument("--n_rollout_threads", type=int, default=1,  ## 32
                        help="Number of parallel envs for training rollouts")
    parser.add_argument("--n_eval_rollout_threads", type=int, default=32, ## 32
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='antiAttack', help="specify the name of environment")
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global state or concatenated obs")
    parser.add_argument("--assign_model_policy", type=str, default="distance",
                        help="assign missiles with 'distance', 'TNT', 'speed', 'comprehensive' estimations ")
    parser.add_argument("--lunch_model_bal", type=bool, default=True,
                        help="lunch model for battalion: fire or not;"
                             "True means lunch the number of missiles;"
                             "False means weather to fire or not")
    ...
    parser.add_argument("--use_centralized_V", action='store_false', # by default True, 因为只用了state，（实际上就是用的obs）
